...
export default {
  ...
  methods: {
    intentarDescubrir() {
      // Emitir el evento para intentar descubrir el Pokémon
...
<template>
    <div class="pokemon-card">
      ...
      <!-- Nombre del Pokémon (solo visible si está descubierto) -->
      <span v-show="pokemon.descubierto"> {{ pokemon.name }}</span>
      
      <!-- Campo de texto para ingresar el nombre (visible si no está descubierto) -->
      <input
